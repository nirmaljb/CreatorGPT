...
name: prd-to-issues
description: >
  Break a PRD into independently-workable issues and write each as a local
  markdown file in issues/. Use when the user wants to turn a PRD into a
...
Use the following template when writing each issue file:
