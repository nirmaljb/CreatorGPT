...
1. **Understand the request**: Read what the user wants — component, page, application, or interface. Note any context about purpose, audience, or technical constraints.
2. **Commit to a bold aesthetic direction** (see Design Thinking below) before writing a single line of code.
3. **Implement working code** (HTML/CSS/JS, React, Vue, etc.) that is production-grade, visually striking, and meticulously refined.
4. **Deliver the code** with a one-line description of the aesthetic direction chosen and why.

Never settle for the first safe option. Surprise the user.
