...
name: write-a-prd
description: >
  Generate a PRD from the client brief and write it as a local markdown file
  in issues/. Use when the user wants to turn a client request into a
  structured PRD.
---
...
Use the following template when writing the PRD:
